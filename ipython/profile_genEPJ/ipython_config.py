...
#c.InteractiveShellApp.code_to_run = 'show_welcome(config.version)',
...
c.InteractiveShell.banner1 = 'Welcome to genEPJ!'
c.InteractiveShell.exit_msg = 'Thanks for using genEPJ. If you found this useful, consider contributing to the project at PATERON'
...
***My Customize genEPJ messaging...
  ...
  Consider contributing to the project at PATERON to keep development progressing.')
"""
